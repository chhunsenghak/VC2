                ...
                <div class="bg-white shadow-md rounded my-6 p-5">
                    <form method="POST" action="{{ route('admin.district.store') }}">
                        ...
                        <div class="flex flex-col space-y-2">
                            <label for="name" class="text-gray-700 select-none font-medium">Province Name</label>
                        ...
                        <div class="flex flex-col space-y-2">
                            <label for="province" class="text-gray-700 select-none font-medium">Province</label>
                            <select name="province_id" id="" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200">
