                ...
                <div class="bg-white shadow-md rounded my-6 p-5">
                    <form method="POST" action="{{ route('admin.limitDuration.update',$limitDuration->id)}}">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <input id="name" type="text" value="{{ old('name',$limitDuration->price) }}" name="name" placeholder="Enter name" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" />
                        </div>
