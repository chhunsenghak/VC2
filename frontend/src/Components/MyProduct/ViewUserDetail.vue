<template>
  <WebLayout>
    <div class="container p-0" style="width:100%; height:100vh">
      <div class="User-info p-10 mt-30 text-white d-flex gap-10">
         <!-- User's profile picture -->
         <div class="ml-40 mt-15 d-flex align-center justify-center">
           
          <img
            class="img-fluid rounded-circle bg-success w-55 h-55"
        ...
        <div class=" info mt-15 w-90">
          ...
          <p>Job: </p>
          <p>
            <b>About me:</b> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Assumenda
            magni dicta sapi
          </p>
          <p>
            <a
          ...
          <div class="collapse" id="collapseExample">
            <div class="card card-body text-dark">
              ...
              <p>
                ...
                ></a>
                <a
                  href="https://t.me/+vGCwghcDP_s5YjM9"
                  ...
                  >
                    ...
                    /></svg
                ></a>
                <a href="#" class="text-success mr-4" style="font-size: 1.5rem"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
