    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12  text-center">
          ...
          <p class="mb-4">
           <q><strong>ផ្សារកសិករ</strong> ផ្តល់តែផលិតផលមានគុណភាព និងផលិតផលសុខភាព តម្លៃសមរម្យ សម្រាប់អ្នកទាំងអស់គ្នា។</q>
          </p>
        </div>
        <!-- End Column 1 -->
        ...
        <div class="col-12 col-md-2 col-lg-2 mb-5 mb-md-0">
          <a class="product-item" href="/">
            <img
              ...
              width="130px"
            />
            <h3 class="product-title">ប៉េងប៉ោះ</h3>
        ...
        <div class="col-12 col-md-2 col-lg-2 mb-5 mb-md-0">
          <a class="product-item" href="/">
            ...
            <h3 class="product-title">ផ្លែប៊្លូបឺរី</h3>
            <span class="icon-cross">
              <img src="../../assets/images/cross.svg" class="img-fluid" />
            </span>
          </a>
