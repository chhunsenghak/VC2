...
<template>
  <header class="flex justify-between px-50 py-3 bg-white items-center m-0">
    ...
    <div class="flex items-center space-x-2">
      <img src="../image/logo2.jpg" alt="" width="80px" height="80px">
    </div>

    <!-- Menu Items -->
    <nav class="flex justify-center gap-5 space-x-4 " id="nav">
      <router-link class="font-bold px-2 py-2 text-dark-700 fs-6 rounded-lg hover:text-blue-700" to="/post"
        style="text-decoration: none;">HOME</router-link>
      <router-link class="font-bold px-2 py-2 text-dark-700 fs-6 rounded-lg  hover:text-blue-700" to=""
