...
<template>
  <nav
    ...
    <div
      class="noti mt-2​ nav-link font-bold link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover px-3 py-2 text-slate-700 rounded-lg hover:bg-slate-200 hover:text-slate-900"
    ...
    <el-dialog v-model="dialogVisible" title="ព័ត៍មាន​​ ឬសារជូនដំណឹង" width="500" :before-close="handleClose">
      ...
      <div class="card border-2 mb-2" style="max-width: 28rem">
        ...
        <div class="card-body ">
          ...
          <p class="card-text">ការបង្កើតហាងរបស់អ្នកទទួលបានជោគជ័ត​ លោកអ្នកអាចចាប់ផ្ដើមលក់និងទិញផលិតផលនៅលើ​ Website
            ដោយប្រើអាខោនរបស់អ្នក </p>
        </div>
      </div>
      <template #footer>
          ...
          <div class="icon-menu mt-10 d-flex flex-column gap-5 w-100">
            ...
            <el-dialog v-model="dialogVisible" title="ព័ត៍មាន​​ ឬសារជូនដំណឹង" width="500" :before-close="handleClose">
              ...
              <div class="card border-2 mb-2" style="max-width: 28rem">
                ...
                <div class="card-body ">
                  <h5 class="card-title">ការបង្កើតហាង</h5>
                  <p class="card-text">ការបង្កើតហាងរបស់អ្នកទទួលបានជោគជ័ត​ លោកអ្នកអាចចាប់ផ្ដើមលក់និងទិញផលិតផលនៅលើ​
                    Website
                    ដោយប្រើអាខោនរបស់អ្នក </p>
                </div>
              </div>
